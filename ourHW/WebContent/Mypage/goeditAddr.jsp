...
function checkvalue(frm){
	...
	function editAddr(frm){
		if (confirm("정말 변경하시겠습니까?") == true){
		frm.action="controller?type=editAddr";
		frm.submit();
		return false;
		}
	}
...
<div class="w3-container w3-center">
	...
	<h5><strong>배송 주소록 변경</strong></h5>
	<h6>자주 쓰는 배송지를 변경 하실 수 있습니다.</h6>
	...
	<form method="post">
		...
		<br>
				<button type="button" class="w3-button w3-black" onclick="checkvalue(this.form)">변경</button>
