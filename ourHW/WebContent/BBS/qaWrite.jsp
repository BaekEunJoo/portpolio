...
<div class="container align-content-center">
	...
	<div>
		<form action="BBSController">
			...
			<thead>
			<tr>
				<td colspan="2"><strong>Q&A 작성</strong></td>
			</tr>
			</thead>
			<tbody>
			<tr>
			...
			<tr>
				<td colspan="2">
					<input type="hidden" name="type" value="insertQA">
					<input type="hidden" name="userId" value=${user.userId }>
					<input type="hidden" name="userName" value=${user.name }>
					<input type="button" onclick="insert_qa(this.form)" value="작성" class="btn btn-outline-dark">
